  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        ...
        {/* ZIP Code - Moved to top with explanation */}
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-blue-700">
                <strong>ZIP Code is the only required field</strong> - We use this to find local contractors in your area. Other address details are optional but help contractors provide more accurate bids.
              </p>
            </div>
          </div>
        </div>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel><span className="text-red-500">*</span> ZIP Code</FormLabel>
              <FormControl>
                <Input 
                  placeholder="12345" 
                  {...field} 
                  onChange={(e) => handleZipChange(e.target.value)}
                  className="max-w-[200px] border-2 border-blue-300 focus:border-blue-500"
                />
              </FormControl>
              <FormMessage />
            </FormItem>
