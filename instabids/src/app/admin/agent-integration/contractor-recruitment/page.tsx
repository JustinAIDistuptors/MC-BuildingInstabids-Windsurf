  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold">Contractor Recruitment Agent</h1>
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="p-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-dashed border-gray-300 text-center">
            <p className="text-gray-500 mb-2">
              This is the integration point for your contractor recruitment agent system.
            </p>
        ...
        <div className="bg-gray-50 px-6 py-4">
          ...
          <div className="mt-2 text-sm text-gray-500">
            <p className="mb-1">• GET /api/admin/agent-integration/contractor-recruitment/config</p>
            <p className="mb-1">• POST /api/admin/agent-integration/contractor-recruitment/config</p>
            <p className="mb-1">• GET /api/admin/agent-integration/contractor-recruitment/stats</p>
            <p>• POST /api/admin/agent-integration/contractor-recruitment/activate</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <StatCard label="Outreach Messages" value="0" />
          <StatCard label="Contractor Sign-ups" value="0" />
          <StatCard label="Conversion Rate" value="0%" />
        </div>
      </div>
      
      {/* Bid Request Handling Section */}
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-lg font-medium text-gray-900 mb-4">Bid Request Processing</h2>
        <div className="border rounded-lg overflow-hidden">
          <div className="px-6 py-4 border-b bg-gray-50 text-sm font-medium text-gray-500">
            No active bid requests to process
          </div>
        </div>
      </div>
